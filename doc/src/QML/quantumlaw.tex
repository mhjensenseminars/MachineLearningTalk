...
\begin{itemize}
\item In this seminar I will try to give a pedestrian yet comprehensive overview of the fundamental principles underpinning quantum technologies.

\item I will examine how these ideas are translated into contemporary technological applications.
...
\begin{tikzpicture}
  ...
  \node[anchor=south west,orange!80!black] at (axis cs:2014,200) {Volta V100 (\SI{15.7}{TFLOPs})};
  \node[anchor=south west,orange!80!black] at (axis cs:2014,2000) {Ampere A100 (2020, \SI{19.5}{TFLOPs})};
  \node[anchor=south west,orange!80!black] at (axis cs:2014,10000) {Hopper H100 (2022,\SI{60}{TFLOPs})};
  \end{semilogyaxis}
\end{tikzpicture}
...
\begin{frame}
\frametitle{And not exactly environmetally friendly}
\begin{itemize}
...
\item Spin qubits—realized in silicon quantum dots, donor atoms, or color centers—encode information in electron or nuclear spin states.
  \item such as electrons on helium/neon (more on this below)
