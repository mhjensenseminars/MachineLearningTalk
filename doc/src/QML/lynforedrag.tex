...
\begin{frame}[plain,fragile]
\frametitle{Multiscale scientific problem and Machine learning/AI}
...
\textbf{With AI/ML we normally intend a collection of machine learning methods with an emphasis on statistical learning and data analysis}
\end{frame}
...
\item Transformers; Reinforcement Learning; Agentic AI, and more 
\end{enumerate}
...
\item Quantum technologies, quantum information theory, quantum computing, quantum sensing and more. 
  \begin{enumerate}
  \item Quantum Technology Bachelor of Science program  \url{https://www.uio.no/studier/program/kvanteteknologi/}
  \item Quantum Technology  Master of Science program \url{https://www.uio.no/english/studies/programmes/quantum-technology/}
