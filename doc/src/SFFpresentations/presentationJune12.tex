...
\begin{frame}{Starting discussion about localization}
  \begin{itemize}
    \item Lead suggestion: Justin and Thomas
    \item Estimate on how many we could be
    \item Need to get started as soon as possible
  \end{itemize}
\end{frame}
...
\begin{frame}{PIs and associated researchers}
\begin{table}[h]
\centering
\footnotesize
\setlength{\tabcolsep}{4.5pt}
\renewcommand{\arraystretch}{1.15}
\begin{tabular}{@{}llllccccll@{}}
\toprule
...
\begin{frame}{Budget}
  \begin{itemize}
  \item Lasse gives a brief intro and overview
  \end{itemize}
\end{frame}
