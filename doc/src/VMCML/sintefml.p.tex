...
%% doconce format latex sintefml.do.txt --latex_title_layout=beamer --latex_table_format=footnotesize --no_mako
%%
...
% !split
\subsection{Generical approaches to probability models}
...
% !split
\subsection{Final expression for the gradients}
...
% !split
\subsection{Examples of gradient expressions}
...
% !split
\subsection{Parametric matrix models for rgression type problems}
...
% !split
\subsection{Calcilating eigensystem}
...
% !split
\subsection{Ordering eigenpairs}
