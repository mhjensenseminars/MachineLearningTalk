...
%% doconce format latex QFC2024.do.txt --latex_title_layout=beamer --latex_table_format=footnotesize --no_mako
%%
...
\title{Artificial intelligence and quantum many-body problems}
...
\begin{block}{}
These slides and more at \href{{https://github.com/mhjensenseminars/MachineLearningTalk/tree/master/doc/pub/QFC2024}}{\nolinkurl{https://github.com/mhjensenseminars/MachineLearningTalk/tree/master/doc/pub/QFC2024}}
\end{block}
...
\textbf{And two Nobel prizes this year!}
...
% !split
\subsection{ML in Nuclear  Physics (or any field, almost)}
...
% !split
\subsection{Physics inspired neural networks}
...
% !split
\subsection{Nuclear many-body problem (or any many-body problem}

\vspace{6mm}

% inline figure
\centerline{\includegraphics[width=1.1\linewidth]{figures/mbpfig1.png}}
...
% inline figure
\centerline{\includegraphics[width=1.0\linewidth]{figures/mbpfig3.png}}
...
% !split
\subsection{Possible start to raise awareness about ML in our own field}
\begin{block}{}
\begin{itemize}
...
% !split
\subsection{Binary-binary model}
