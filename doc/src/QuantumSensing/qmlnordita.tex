...
\column{6cm}
      \begin{center}
	\includegraphics[width=1.2\textwidth]{qcfigures/figure1.pdf}
      \end{center}
\end{columns}
      \end{footnotesize}
    }
...
\begin{frame}[plain,fragile]
\frametitle{Harmonic oscillator double well}
...
\centerline{\includegraphics[width=0.9\linewidth]{qcfigures/figure_003.png}}

%\vspace{6mm}
\end{frame}

\begin{frame}[plain,fragile]
\frametitle{Entanglement again}

%\vspace{6mm}

\centerline{\includegraphics[width=0.9\linewidth]{qcfigures/figure_004.png}}
...
\end{itemize}
This is a \textbf{quantum sensing} protocol where entanglement enhances sensitivity to weak fields! Here we apply a weak oscillating field: $B(t) = B_0 \sin(\omega t)$
...
\begin{frame}[plain,fragile]
\frametitle{Leakage to triplet states}

%\vspace{6mm}

\centerline{\includegraphics[width=0.9\linewidth]{qcfigures/figure_006.png}}
...
\centerline{\includegraphics[width=0.9\linewidth]{qcfigures/figure_008.png}}
...
We now implement a \textbf{model-based reinforcement learning} approach to optimize the control sequence for quantum sensing. Since we know the Hamiltonian, we can simulate the quantum dynamics and use RL to find optimal control strategies.
