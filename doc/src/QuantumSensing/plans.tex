...
\begin{block}{}
\begin{itemize}
\item Development of many-body theories and new methods with and without machine learning (classical and quantum)
...
\begin{frame}[plain,fragile]
\frametitle{Quantum sensing: Singlet-triplet leakage for entangled electrons on helium}
