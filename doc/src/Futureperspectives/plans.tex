...
\title{Machine Learning (classical and quantum) and Quantum Technologies for Quantum Control}
...
\begin{block}{}
\begin{itemize}
\item Development of many-body theories (with and without time-dependence) and new methods with and without machine learning (classical and quantum)
\item Quantum engineering of devices for quantum circuits and quantum sensors (DRD5 project at CERN, HEP and NP applications)
\item Reinforcement learning (quantum and classical) for optimization of quantum control
\item Studies of noise in quantum computing and coupling to the environment
\end{itemize}
\end{block}
...
\begin{frame}[plain,fragile]
\frametitle{Vision for the future}

%\vspace{6mm}

\centerline{\includegraphics[width=1.0\linewidth]{qcfigures/Futurevision.pdf}}
...
\footnotesize{
  \centering
    \begin{tabular}{c|c|c|cc|cc}
      ...
      6 & 0.001 & --- & $0.0137948(8)$ & --- & $\mathbf{0.013778(1)}$ & --- \\
...
\begin{frame}[plain,fragile]
\frametitle{Parametric Matrix Models, Trotterization, Unitary CC, time-dependence  and quantum computing}
      \begin{footnotesize}
     \begin{columns}
       \column{5.0cm}
...
\begin{frame}[plain,fragile]{Novel approach to time-dependent DFT (TTDF) }

We are implementing physics-informed neural networks wiht PMMs to time-dependent DFT. First applications to appear soon. Considerable improvements over traditional TDDFT. 

\end{frame}


\begin{frame}[plain,fragile]
\frametitle{Quantum engineering, Di Vincenzo criteria}
...
\begin{frame}
\frametitle{Our quantum computing platform, electrons on helium}
  {
...
\begin{enumerate}
\item Niyaz R. Beysengulov, Johannes Pollanen, Øyvind S. Schøyen, Stian D. Bilek, Jonas B. Flaten, Oskar Leinonen, Håkon Emil Kristiansen, Zachary J. Stewart, Jared D. Weidman, Angela K. Wilson, Morten Hjorth-Jensen, {\em Coulomb interaction-driven entanglement of electrons on helium}, PRX Quantum {\bf 5}, 030324 (2024).
\item Oskar Leinonen, Jonas B. Flaten, Stian D. Bilek, Øyvind S. Schøyen, Morten Hjorth-Jensen, Niyaz R. Beysengulov,  Zachary J. Stewart, Jared D. Weidman, Angela K. Wilson, {\em Design and Dynamics of High-Fidelity Two-Qubit Gates with Electrons on Helium}, "Physical Review A {\bf 113}, 032624 (2026).
\item Juan Manuel Scarpetta, John Henry Reina, and Morten Hjorth-Jensen, {\em Machine learning non-Markovian two-level quantum noise spectroscopy}, Physical Review Research {\bf 7}, 043285 (2025).
\item   Niyaz R. Beysengulov,  Stian D.~Bilek, Antoine Camper, Jonas B.~Flaten, Morten Hjorth-Jensen, Gunnar F.~Lange, Oskar Leinonen, Jan Malamant, Francesco P.~Massel, Johannes Pollanen, Heidi Sandaker, Zachary J.~Stewart, Viktor Svensson, Jared D.~Weidman,
{\em Electrons on  Helium and Entangled Quantum Sensors for Particle Physics} , Communication Physics, (2026), in press.
\end{enumerate}
...
\begin{frame}[plain,fragile]
\frametitle{Exampe: Platform for quantum sensing: Singlet-triplet leakage for entangled electrons on helium}
...
We are implementing a \textbf{model-based reinforcement learning} approach to optimize the control sequence for quantum sensing. Since we \textbf{know the Hamiltonian}, we can simulate the quantum dynamics and use RL to find optimal control strategies.
...
\begin{alertblock}{What we have now}
\begin{itemize}
...
\begin{alertblock}{RL and quantum control inspiration}
\begin{itemize}
\item {\bf Reinforcement Learning for Quantum Technology}, by Marin Bukov and Florian Marquardt, arXiv:2601.18953
