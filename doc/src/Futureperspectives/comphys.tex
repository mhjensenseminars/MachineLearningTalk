...
\date{AI, Quantum Technology and Neurotechnology}
...
machine learning, quantum technologies, and 
neurotechnology. By bringing together these rapidly evolving fields, the
...
\begin{frame}{People}
  ...
  \item Tor Ole Odden
  \item Henrik Sveinsson
  \item Adjunct (Prof.~II, 20$\%$) Gaute Einevoll (NMBU) and Francesco P.~Massel (USN)
...
\item computational neurotechnology
...
\begin{frame}{Computational Neurotechnology and Physics}

Another rapidly growing frontier is computational neurotechnology.
...
The interaction between neurotechnology and machine learning is
...
AI, and neurotechnology are becoming increasingly connected.
...
Combining physics, AI, and neurotechnology may therefore
